<div class="row hidden">
    <div class="card col-md-10 shadow-sm d-flex">
        <div class="card-body mt-0">
            ...
            <div class="row">
                <ul class="nav col-md-12 nav-pills mb-1" id="pills-tab-milieu" role="tablist">
                    <li class="nav-item ">
                        <a class="nav-link active rounded-pill" id="pills-impact-energie-tab" data-toggle="pill" href="#pills-impact-energie" role="tab" aria-controls="pills-milieu" aria-selected="true">Energie</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link rounded-pill" id="pills-impact-water-tab" data-toggle="pill" href="#pills-impact-water" role="tab" aria-controls="pills-milieu" aria-selected="false">Water</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link rounded-pill" id="pills-impact-geluid-tab" data-toggle="pill" href="#pills-impact-geluid" role="tab" aria-controls="pills-milieu" aria-selected="false">Geluidsniveau</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link rounded-pill" id="pills-impact-afval-tab" data-toggle="pill" href="#pills-impact-afval" role="tab" aria-controls="pills-milieu" aria-selected="false">Afval</a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                <!-- ELECTRICITY -->
                <div class="tab-pane fade show active" id="pills-impact-energie" role="tabpanel" aria-labelledby="pills-impact-energie-tab">
                    <div class="row">
                        <ul class="nav  mb-1" id="pills-tab-milieu" role="tablist">
                            <li class="nav-item ">
                                <a class="nav-link active border-bottom" id="pills-energie-gevolgen-tab" data-toggle="pill" href="#pills-energie-gevolgen" role="tab" aria-controls="pills-milieu-extend" aria-selected="true" style="color:#05386B;">GEVOLGEN</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " id="pills-energie-tips-tab" data-toggle="pill" href="#pills-energie-tips" role="tab" aria-controls="pills-milieu-extend" aria-selected="false" style="color:#05386B;">TIPS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  " id="pills-energie-uitdagingen-tab" data-toggle="pill" href="#pills-energie-uitdagingen" role="tab" aria-controls="pills-milieu-extend" aria-selected="false" style="color:#05386B;">UITDAGINGEN</a>
                            </li>
                            </u>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="pills-energie-gevolgen" role="tabpanel" aria-labelledby="pills-impact-energie-tab">
                            <ul class="mt-3">
                                <li>
                        ...
                        <div class="tab-pane fade" id="pills-energie-tips" role="tabpanel" aria-labelledby="pills-impact-energie-tab">
                            <ul class="mt-3">
                                <li>
                        ...
                        <div class="tab-pane fade" id="pills-energie-uitdagingen" role="tabpanel" aria-labelledby="pills-impact-energie-tab">
                            <ul class="mt-3">
                                <li>
                ...
                <!-- WATER -->
                <div class="tab-pane fade" id="pills-impact-water" role="tabpanel" aria-labelledby="pills-impact-water-tab">
                    <div class="row">
                        <ul class="nav  mb-1" id="pills-tab-milieu" role="tablist">
                            <li class="nav-item ">
